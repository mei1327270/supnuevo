angular.module('app')
.controller('loginController',function($scope,$state,$ionicLoading,$http,$cordovaProgress,$cordovaNetwork,$cordovaCamera,locals){
    $scope.user = [{
      'username':'',
      'password':'',
    }];
    ...
    $scope.goQuery = function(){
      ...
      if($cordovaNetwork.isOnline()){
        ...
        $http({
          ...
          url:"http://211.87.225.210:8080/supnuevo/supnuevo/supnuevoGetUserLoginJSONObjectMobile.do?loginname="+user.username+"&password="+user.password,
          ...
          if(errorMsg !== null && errorMsg !== undefined && errorMsg !== ""){
            ...
            var supnuevoMerchantId = response.supnuevoMerchantId;
